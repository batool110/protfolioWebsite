...
class SkillCardData {
  ...
  SkillCardData({required this.title, required this.iconData,required this.description, this.flutter, required this.iconColor});
}
            ...
            Column(
              ...
              children: [
                 CircularContainer(
                  ...
                  child: widget.flutter == true ? FlutterLogo(size: widget.iconSize) : null,
                ),
                SpaceH12(),
                SelectableText(
                  widget.title,
